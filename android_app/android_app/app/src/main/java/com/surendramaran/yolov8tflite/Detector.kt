...
class Detector(
    ...
    fun setup(
        ...
        try {
            ...
            Log.d("AppPerformanceInfo", "Just executed: Add image labels in object Detector")
    ...
    fun detect(
        ...
        Log.d("AppPerformanceInfo", "Just executed: createScaledBitmap of object")
        logPerformanceInfo.getAllPerformanceInfo(
            memoryInfo,
            activityManager,
            context = applicationContext
    ...
    private fun bestBox(
        ...
        Log.d("AppPerformanceInfo", "Just executed: bestBox to find best bounding box for object")
        logPerformanceInfo.getAllPerformanceInfo(
            memoryInfo,
            activityManager,
            context = context
